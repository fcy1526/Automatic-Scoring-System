package com.fcy.scoreservice.common;
...
public class Constants {
    ...
    // 个人中心权限id字符串
    public static final String PERSONAL_AUTH_STR = "1,109,10901,10902,10903";
    // 新增课程 初始阶段为0
    public static final Integer CURRENT_STAGE_INSERT = 0;
    // 评分总占比
    public static final Integer PROPORTION_SUM = 100;
}
